-file("/Users/alexey.bolshakov/.asdf/installs/erlang/22.3.1/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("./priv/lexer.xrl", 21).
 
% rc_cli_lexer:string("--").
 
%
 
-file("/Users/alexey.bolshakov/.asdf/installs/erlang/22.3.1/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
-file("./priv/lexer.xrl", 6).
yyaction_0(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("./priv/lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_2/0}).
-file("./priv/lexer.xrl", 9).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/2}).
-file("./priv/lexer.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./priv/lexer.xrl", 15).
yyaction_4(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("./priv/lexer.xrl", 17).
yyaction_5(TokenChars, TokenLine) ->
     { token, { str1, TokenLine, list_to_binary (lists : sublist (TokenChars, 2, length (TokenChars) - 2)) } } .

-file("/Users/alexey.bolshakov/.asdf/installs/erlang/22.3.1/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
